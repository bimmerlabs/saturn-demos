...
LightSource light1 = {toFIXED(127), toFIXED(127), toFIXED(0), 90, 0, 0};  // scene light
LightSource light2 = {toFIXED(127), toFIXED(127), toFIXED(0), 10, 0, 0};  // scene light
LightSource light3 = {toFIXED(0), toFIXED(100), toFIXED(0), 10, 0, 0};  // scene light
